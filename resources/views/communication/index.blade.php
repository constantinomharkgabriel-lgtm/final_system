...
{{-- Only add sidebar-links if layout supports it (department or HR layouts) --}}
@if(in_array($layout, ['department.layouts.app', 'hr.layouts.app']))
