        ...
        <div class="rounded-2xl border border-gray-700 bg-gray-800 p-6 shadow-sm">
            ...
            <form method="POST" action="{{ route('marketplace.profile.update') }}" class="mt-5 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" placeholder="+639123456789 or 09123456789" class="w-full rounded-lg border border-gray-600 bg-white px-3 py-2 text-black">
