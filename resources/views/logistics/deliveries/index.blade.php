...
<div class="flex gap-2">
    <a href="{{ route('logistics.deliveries.schedule') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">📅 Schedule</a>
    <a href="{{ route('logistics.deliveries.create') }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">+ New Delivery</a>
</div>
@endsection
...
<div class="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-6">
    <form method="GET" class="flex flex-wrap gap-4">
        <select name="status" class="px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500">
        ...
        <input type="date" name="date" value="{{ request('date') }}"
            class="px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-600">
                ...
                <tr class="hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4">
                        @if($delivery->driver)
                        <span class="text-purple-600">{{ $delivery->driver->name }}</span>
                        @else
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <a href="{{ route('logistics.deliveries.edit', $delivery) }}" class="text-green-400 hover:text-green-300 text-sm">Edit</a>
                            @endif
                        </div>
                    </td>
                </tr>
