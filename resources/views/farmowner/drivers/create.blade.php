...
@section('content')
<div class="max-w-2xl">
    <form action="{{ route('drivers.store') }}" method="POST" class="bg-gray-800 border border-gray-700 rounded-lg p-6">
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('drivers.index') }}" class="px-6 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-500">Cancel</a>
        </div>
    </form>
</div>
@endsection
