...
class MobileMarketplaceController extends Controller
{
     ...
     * Mobile app calls this after success redirect to ensure payment is confirmed.
     */
    public function verifyPaymentStatus(Request $request, Order $order): JsonResponse
    {
        ...
        if ((int) $order->consumer_id !== (int) $consumer->id) {
        ...
        $checkoutSessionId = Cache::get("marketplace_checkout_session_{$order->id}");
        $paymentLinkId = Cache::get("marketplace_payment_link_{$order->id}");
