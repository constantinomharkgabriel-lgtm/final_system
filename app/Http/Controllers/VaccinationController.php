...
use App\Services\SupplyConsumptionService;
...
class VaccinationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Record supply consumption (vaccine)
        try {
            $supplyService = new SupplyConsumptionService();
            $supplyService->recordVaccineConsumption($vaccination);
        } catch (\Exception $e) {
            // Log error but don't fail the vaccination save
            \Illuminate\Support\Facades\Log::warning('Supply consumption recording failed', [
                'vaccination_id' => $vaccination->id,
                'error' => $e->getMessage(),
            ]);
        }

        return redirect()->route('vaccinations.index')->with('success', 'Vaccination record created and supply updated.');
    }
    ...
    public function update(Request $request, Vaccination $vaccination)
    {
        ...
        return redirect()->route('vaccinations.show', $vaccination)->with('success', 'Vaccination updated successfully.');
    }
