...
class DeliveryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view($this->viewPath('deliveries.index'), compact('deliveries', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return view($this->viewPath('deliveries.create'), compact('drivers', 'orders'));
    }
    ...
    public function show(Delivery $delivery)
    {
        ...
        return view($this->viewPath('deliveries.show'), compact('delivery', 'availableDrivers'));
    }
    ...
    public function edit(Delivery $delivery)
    {
        ...
        return view($this->viewPath('deliveries.edit'), compact('delivery', 'drivers'));
    }
    ...
    public function update(Request $request, Delivery $delivery)
    {
        ...
        $validated = $request->validate([
            ...
            'status' => 'nullable|in:preparing,packed,assigned,out_for_delivery,delivered,completed,failed',
            'delivery_fee' => 'nullable|numeric|min:0',
            'special_instructions' => 'nullable|string',
            'delivery_notes' => 'nullable|string',
        ]);

        // If driver is assigned, update status to 'assigned'
        if ($validated['driver_id'] && !$validated['driver_id'] != $delivery->driver_id) {
    ...
    public function schedule()
    {
        ...
        $scheduleView = $this->isLogisticsPortal() ? 'logistics.deliveries.schedule' : 'department.deliveries.schedule';
        return view($scheduleView, compact('today', 'tomorrow', 'unscheduled', 'drivers'));
    }
}
