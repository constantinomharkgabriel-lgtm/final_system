...
class Payroll extends Model
{
    ...
    protected $fillable = [
        ...
        'overtime_hours', 'delivery_count', 'basic_pay', 'overtime_pay', 'holiday_pay', 'delivery_commission', 'allowances',
        ...
        'paymongo_session_id', 'paymongo_payment_intent_id', 'payment_details'
    ];
