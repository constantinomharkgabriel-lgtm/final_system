...
class FarmOwner extends Model
{
    ...
    protected $fillable = [
        ...
        'business_permit_path', 'barangay_clearance_path', 'mayor_bir_registration_path', 
        'ecc_certificate_path', 'bai_registration_path', 'locational_clearance_path',
    ...
    /**
     * Return a browser-safe URL for the business permit document.
     */
    public function getBusinessPermitUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->business_permit_path);
    }

    /**
     * Return a browser-safe URL for the barangay clearance document.
     */
    public function getBarangayClearanceUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->barangay_clearance_path);
    }

    /**
     * Return a browser-safe URL for the mayor's BIR registration.
     */
    public function getMayorBirRegistrationUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->mayor_bir_registration_path);
    }

    /**
     * Return a browser-safe URL for the ECC certificate.
     */
    public function getEccCertificateUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->ecc_certificate_path);
    }

    /**
     * Return a browser-safe URL for the BAI registration.
     */
    public function getBaiRegistrationUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->bai_registration_path);
    }

    /**
     * Return a browser-safe URL for the locational clearance.
     */
    public function getLocationalClearanceUrlAttribute(): ?string
    {
        return $this->getStorageUrl($this->locational_clearance_path);
    }

    /**
     * Helper method to convert file paths to public URLs.
     */
