...
class Product extends Model
{
    ...
    {
        return $this->belongsTo(EggInventory::class, 'egg_inventory_id');
    }

    public function livestockInventory()
    {
        return $this->belongsTo(LivestockInventory::class, 'livestock_inventory_id');
    }
